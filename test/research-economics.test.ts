...
import { canonicalJson, executionPlanKey } from '../src/research/economics/execution.ts';
import { appendDecision, readDecisionLedger, type DecisionBody } from '../src/research/economics/decisionLedger.ts';
import { evidenceConstrainedFrontier, evidenceDominates, type EvidencePlan } from '../src/research/economics/frontier.ts';
import { summarizeBudgetRisk, updateScarcityDual } from '../src/research/economics/budgetRisk.ts';
import { promotionDecision, type PromotionEvidence } from '../src/research/economics/promotion.ts';
import { assessMetricUse } from '../src/research/economics/metricSafety.ts';
import { applyCapitalTransaction, createCapitalState, totalAvailableCapital, validateCapitalHierarchy } from '../src/research/economics/capital.ts';
import { exactShapleyDecomposition, opportunityGap, standardizedSpendDiagnostic } from '../src/research/economics/decomposition.ts';
import { doublyRobustEstimate, selfNormalizedIps } from '../src/research/economics/offPolicy.ts';
import {
