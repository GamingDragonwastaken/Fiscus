...
This directory holds the records of the Segreant reconstruction program
...
| [SEGREANT-MAGNUM-OPUS-STATE.md](SEGREANT-MAGNUM-OPUS-STATE.md) | Historical program closure record |
