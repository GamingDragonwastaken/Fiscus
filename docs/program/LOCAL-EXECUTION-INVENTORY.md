...
- Canonical main head at the close of reconciliation: `4bc37d5891755fec4bd94b3e8dd8d4d359f57f45` (push CI `35765884653`, success); the record-only follow-up `28dc6dd15c280086c72e018fc2fd43cfb688c965` is green on push run `35773660407`. `ACTIVE-EXECUTION.md` carries the current head.
...
The classification below was re-verified against a full clone on 2026-09-24,
with per-branch commit counts and the exact archive-then-delete commands, in
