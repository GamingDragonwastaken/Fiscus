...
| Last CI-verified exact head | `aa5ec2271132336e30e6968d12eeb54b2aa9cb19` — run `34174439515`, **success on all eight configured jobs** (`test` ×3, `team-server-test` ×3, `package-smoke`, `candidate-head`), inspected job by job, not by trusting the first green row. Verified the same way before it, each all-eight green: `2aa7cac` (run `34174382288`, success), `51f3ec6` (run `34174019795`, success), `0f0811d` (run `34173907843`, success), `0ebb966` (run `34173069140`, success), `e0cd80f` (run `34172882201`, success), `dfcfc87` (run `34171128690`, success), `ac98395` (run `34170679364`, success), `6b91318` (run `34169977899`, success). |
