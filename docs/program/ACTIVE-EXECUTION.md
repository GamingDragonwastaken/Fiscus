...
| Last CI-verified exact head | `0f0811d2ae354da41457c4a0eea99db6cb060233` — run `34173907843`, **success on all eight configured jobs** (`test` ×3, `team-server-test` ×3, `package-smoke`, `candidate-head`), inspected job by job, not by trusting the first green row. `0ebb966` (run `34173069140`), `e0cd80f` (run `34172882201`), `dfcfc87` (run `34171128690`), `ac98395` (run `34170679364`) and `6b91318` (run `34169977899`) were each verified the same way before it. |
| Code ahead of that head | `51f3ec6` (records), `2aa7cac` (analysis-snapshot path) and this records commit. None is verified remotely until its own exact SHA has a completed green run. |
