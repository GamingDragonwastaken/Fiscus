...
become Fiscus Evidence only after the source-specific adapter validates that
...
Fiscus is certified by any standard, that every provider import is FOCUS
