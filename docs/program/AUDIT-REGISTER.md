...
| AII-017 | P0 | Money not exact end-to-end | PARTIAL | Provider/local/reconciliation kernel paths and an opt-in atomic exact request-charge bridge use exact Money and canonical coefficients; migrate live proxy/import pricing and legacy request ledger/DB/budgets/allocation/API/CSV authoritative paths |
