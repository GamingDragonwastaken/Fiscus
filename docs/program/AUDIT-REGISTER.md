...
| AII-018 | P1 | Missing analytical economic subledger | PARTIAL | Immutable EconomicEvent foundation, exact decimal pricing boundary, role-aware append-only persistence, deterministic projections, and bounded one-source additive price corrections exist locally; complete typed event-role/conservation semantics, correction integration, FX/allocation/close integration and product consumers remain |
