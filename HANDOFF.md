...
with [docs/program/ACTIVE-EXECUTION.md](docs/program/ACTIVE-EXECUTION.md), those
...
- **The reconstruction program is finished.** Execution Dossier III (76
  ...
  in [docs/program/REPOSITORY-HYGIENE.md](docs/program/REPOSITORY-HYGIENE.md).
- **Current phase: pre-launch.** The work is now release, positioning and
  ...
  [ACTIVE-EXECUTION.md](docs/program/ACTIVE-EXECUTION.md#current-phase-pre-launch).
- **Blocking owner decision:** the name. `fiscus` on npm belongs to an
  unrelated project in the AI-agents-and-money space
  ([NAME-COLLISION-REVIEW.md](docs/NAME-COLLISION-REVIEW.md)). Nothing is
...
- **Not done, and not claimable:** npm publication, a GitHub release, real
  ...
  security review. [EXTERNAL-GATES.md](docs/program/EXTERNAL-GATES.md) says what
  each one needs.
...
| The hard rules and the three typecheck passes | [CLAUDE.md](CLAUDE.md) |
| What may be claimed publicly | [docs/CAPABILITY-EVIDENCE-CONTRACT.md](docs/CAPABILITY-EVIDENCE-CONTRACT.md) |
| User-facing docs | [docs/README.md](docs/README.md) |
| Cutting a release | [docs/RELEASE-PROCESS.md](docs/RELEASE-PROCESS.md), [docs/RELEASE-GATE.md](docs/RELEASE-GATE.md) |
| Why something was decided | [docs/program/DECISION-LOG.md](docs/program/DECISION-LOG.md) |
| Proof the reconstruction closed | [docs/program/FINAL-GATE.md](docs/program/FINAL-GATE.md) |
